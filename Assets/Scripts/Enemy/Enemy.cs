...
public class Enemy : MonoBehaviour
{
    ...
    public bool playerInTheLeftOfCenter => centerPoint.transform.position.x > playerController.transform.position.x;
    public bool playerInTheAreaOfPatrol => playerInTheLeftOfCenter ? playerController.transform.position.x <
        patrolPoints[0].transform.position.x : playerController.transform.position.x > patrolPoints[0].transform.position.x;
